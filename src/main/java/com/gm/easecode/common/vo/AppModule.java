...
public class AppModule {
	...
	/** 列信息 */
	private List<AppModuleProperties> columnList = null;
	
	/** 主健列信息 */
	private List<AppModuleProperties> priColList = null;
	
	/** 是否自增长主健 */
	private boolean isAutoIncrKey = false;
	
	/** 自增长列 */
	private AppModuleProperties autoIncrCol = null;
	...
	public List<AppModuleProperties> getColumnList() {
		return columnList;
	}

	public void setColumnList(List<AppModuleProperties> columnList) {
	...
	public List<AppModuleProperties> getPriColList() {
		return priColList;
	}

	public void setPriColList(List<AppModuleProperties> priColList) {
	...
	public AppModuleProperties getAutoIncrCol() {
		return autoIncrCol;
	}

	public void setAutoIncrCol(AppModuleProperties autoIncrCol) {
	...
	public boolean isAutoIncrCol(AppModuleProperties column){
		if(autoIncrCol == null){
			return false;
		}
	 ...
	 * @return
	 */
	public boolean isPriCol(AppModuleProperties column){
		boolean bRet = false;
		for(int i = 0; i < priColList.size(); ++i){
			AppModuleProperties currCol = priColList.get(i);
