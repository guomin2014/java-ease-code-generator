...
public class AppModuleGroup {
	...
	public AppModuleGroup(int num, String name, String identify, String tables) {
		this(num, name, identify, false, 1, tables);
	}
	
	public AppModuleGroup(int num, String name, String identify, boolean subModuleEnable, int subModuleDepth, String tables)
	{
