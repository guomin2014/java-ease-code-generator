...
public class UniopsFrameProvider extends AbstractFrameworkProvider {
	...
	private void initFrameDependey() {
		...
		dependencyMap.put("common", new Dependey("uniops", "uniops-framework-common"));
		dependencyMap.put("core", new Dependey("uniops", "uniops-framework-core"));
		dependencyMap.put("knife4j", new Dependey("uniops", "uniops-framework-knife4j-spring-boot-starter"));
		dependencyMap.put("interceptor", new Dependey("uniops", "uniops-framework-interceptor-spring-boot-starter"));
		dependencyMap.put("mybatis", new Dependey("uniops", "uniops-framework-mybatis-spring-boot-starter"));
		dependencyMap.put("transaction", new Dependey("uniops", "uniops-framework-transaction-spring-boot-starter"));
		dependencyMap.put("web", new Dependey("uniops", "uniops-framework-web-spring-boot-starter"));
		dependencyMap.put("openfeign", new Dependey("uniops", "uniops-framework-openfeign-spring-boot-starter"));
		dependencyMap.put("xxljob", new Dependey("uniops", "uniops-framework-xxljob-spring-boot-starter"));
